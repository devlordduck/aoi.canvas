...
export declare class CanvasBuilder {
    ...
    fillText(style: string | CanvasGradient, text: string, x: number, y: number, font: string, maxWidth?: number, align?: textAlign, baseline?: textBaseline, multiline?: boolean, wrap?: boolean, lineOffset?: number): Promise<void>;
    strokeText(style: string | CanvasGradient, text: string, x: number, y: number, font: string, strokeWidth?: number, maxWidth?: number, align?: textAlign, baseline?: textBaseline, multiline?: boolean, wrap?: boolean, lineOffset?: number): Promise<void>;
