...
exports.default = new __1.AoiFunction({
    ...
    code: async (ctx) => {
        ...
        let [name, text, style, font = "15px " + canvas_1.GlobalFonts.families[0].family, x, y, maxWidth, align, baseline, multiline, wrap, offset] = ctx.params;
        ...
        await canvas.fillText(style, text, x, y, font, maxWidth, align, baseline, multiline, wrap, offset ?? 0);
        return {
